...
const PromptExample: React.FC = () => {
    ...
    return (
        <div className="w-full lg:w-3/4 flex flex-col items-center space-y-8 relative px-4">
            ...
            <div
                className="absolute top-4 -right-4 md:top-8 md:-right-2 lg:-right-8 bg-primary-800 bg-opacity-90 border border-accent-500 text-accent-400 text-xs md:text-sm lg:text-base px-3 md:px-4 lg:px-5 py-1.5 md:py-2 lg:py-3 rounded-lg shadow-xl flex items-center gap-2"
            >
                <SiOpenai size={20}/>
